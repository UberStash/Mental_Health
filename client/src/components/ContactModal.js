              ...
              <Grid.Row>
                <Grid.Column width={8}>
                  ...
                  <p style={{ fontSize: "1.33em" }}>
                    We can’t wait to connect with you! Whether you’re looking
                    for answers, want help with an issue, or want a personalized
                    demo of the software, we’re excited to get in touch with
                    you! Fill out the form below to be connected to one of our
                    friendly team members. You can also chat with us, call us,
                    email us, or visit our Support Portal any time.
                  </p>
                </Grid.Column>
